    ...
    public class PreprocessAnnotation : ICompileModule
    {
        ...
        public void BeforeCompile(IBeforeCompileContext context)
        {
            ...
            foreach (var method in addAssemblyMethodCalls)
            {
                ...
                //foreach (var newNode in methodNodes) {
                //    newSyntaxRoot = newSyntaxRoot.ReplaceNodes(new[] { method.Declaration.Parent }, (o, r) => newNode);
                //}
                var newSyntaxRoot = oldSyntaxRoot
                    .InsertNodesAfter(method.Declaration.Parent, methodNodes)
                    .RemoveNode(method.Declaration.Parent, SyntaxRemoveOptions.KeepExteriorTrivia)
                    .NormalizeWhitespace();
